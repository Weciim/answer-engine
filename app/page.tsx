        ...
        setMessages((prevMessages) => {
          ...
          if (messageIndex !== -1) {
            ...
            if (typedMessage.conditionalFunctionCallUI) {
              ...
              if (functionCall.trackId)
                currentMessage.spotify = functionCall.trackId;
            }
      ...
      >
        <div className="mx-auto max-w-xl sm:px-4 ">
          {messages.length === 0 && !inputValue && (
            <InitialQueries
              questions={[
                "Donner un cours sur la photosynthèse",
                "درس عن قرطاج الحديثة",
                "Comment simplifier le cours de la puissance",
                "Proposer une structure de cours sur la distance euclidienne",
              ]}
              handleFollowUpClick={handleFollowUpClick}
            />
          )}
